...
const projects = [
  ...
  },
  {
    ...
    description:
      "A modern, responsive gift shop website made for a client, built with React and Tailwind CSS, featuring a clean UI and smooth animations.",
    link: "https://scope-reply-41990655.figma.site",
    image: "/gift_garden.png",
  ...
  {
    title: "CDC Intranet Portal - Redesign",
    description:
      "A modern, responsive intranet portal redesign for CDC, focusing on improved user experience and streamlined workflows.",
    link: "https://www.figma.com/design/JXCr0DMgLmastyGrv3RQAW/CDC-portal-redesign?node-id=1-2&t=e6i6L0bJxJNMgpcv-1",
    image: "/cdc_intranet.png",
